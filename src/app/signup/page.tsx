...
import { initiateSignup, completeOnboarding } from "@/lib/client-auth";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-lg p-6 shadow-sm">
          {phase === 1 ? (
            ...
            <>
              <h2 className="text-xl font-semibold mb-4">Set Up Your Company</h2>
              <p className="text-sm text-muted mb-4">
                Your account has been created. Now let&apos;s set up your company.
              </p>
